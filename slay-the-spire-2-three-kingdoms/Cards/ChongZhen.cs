...
public class ChongZhen : CustomCardModel
{
    ...
    public override string PortraitPath => $"res://slay_the_spire_2_three_kingdoms/images/cards/{nameof(ChongZhen)}.png";
    public ChongZhen() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (cardPlay.Target != null && enumerable != null && enumerable?.Count() > 0)
        {
            ...
            {
                await CardCmd.DiscardAndDraw(choiceContext, new[] { item }, 1);
                break;
            }
